...
namespace CaveRescue
{
    public partial class FrmMainForm : Form
    {
        ...
        public btn cavedesignerlayout = new btn();
            ...
            for (int i = 0; i < 15; i++)
            {
                for (int j = 0; j < 25; j++)
                {
                    ...
                    else if (caveLocations[j, i] == "W") // Just a demonstration of how we can flag other coloured gridspaces (that do nothing).
                    {
                        ...
                        location.LocationTypeText = "Water";
                    }
        ...
        private void btn_Generateusermadecave_Click(object sender, EventArgs e)
        {
            btn cavedesigner = new btn();
            cavedesigner.Show();
        }
    }
}
